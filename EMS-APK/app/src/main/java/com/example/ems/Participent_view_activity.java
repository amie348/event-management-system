...
public class Participent_view_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras() != null){
            ...
            ParticipentDBHelper participentDBHelper = new ParticipentDBHelper(Participent_view_activity.this);
        ...
        finishbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getIntent().getExtras() != null ){
                    ...
                    if(participentDBHelper.updateParticipent(Integer.parseInt(id)  , name , SureName , age  , event , cnic ))
                    {
                    ...
                    if (participentDBHelper.insertParticipent( name , SureName , age  , event , cnic )) {
