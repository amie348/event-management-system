...
public class ParticipentDBHelper extends SQLiteOpenHelper {
    ...
    public ParticipentDBHelper(Context context) {
    ...
    public Participent getData(int Id) {
        ...
        Participent participent = new Participent(id , name, sureName ,  event , age, cnic);
        return participent;
    }
...
*/
    ...
    public List<Participent> getAllParticipents() {
